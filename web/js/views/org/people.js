  ...
  function draw() {
    ...
    body.innerHTML = `
      ...
      <div class="card"><div class="card-head"><h3>People</h3><span class="badge">${users.length}</span></div><div class="card-body org-table-wrap" style="padding:4px 8px">
        <table class="org-table"><thead><tr><th>Person</th><th>Role</th><th class="org-hide-sm">Groups</th><th class="org-hide-sm">Last seen</th>${can("admin") ? '<th class="num org-hide-sm">Budget / month</th>' : ""}${owner ? "<th></th>" : ""}</tr></thead><tbody>
