...
| measured performance work | In Auto, a performance task on a web repository goes to the team: the plan names what to measure and relay-perf measures the starting commit first (merged from main) | `solo.finish_triage`, `perfcheck` |
